...
public partial class MainWindow
{
    ...
    private void ToolOptionsPanelOverlay_CircleSupportApplyRequested(object? sender, System.EventArgs e)
    {
        ...
        if (!_manualSupportTool.ApplyActiveOperation())
        {
            return;
        }

        ExitCircleSupportModeAfterApply();
    }
    ...
    /// <summary>
    /// Leaves the Circle Support operation after Apply and clears all transient Circle Support previews.
    /// </summary>
    private void ExitCircleSupportModeAfterApply()
    {
        HideToolOptionsPanel();
    ...
    {
        if (TryShowSelectedCircleSupportGroupOptions())
        {
            return;
        }
    ...
    /// <summary>
    /// Shows Circle Support settings when the selected support group was generated by the Circle Support tool.
    /// </summary>
    private bool TryShowSelectedCircleSupportGroupOptions()
    {
        ...
        ToolOptionsPanelOverlay.Visibility = System.Windows.Visibility.Visible;
        _manualSupportTool.EditCircleSupportGroup(supportLayerGroup);
