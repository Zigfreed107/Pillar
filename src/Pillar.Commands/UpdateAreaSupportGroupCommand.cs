// UpdateAreaSupportGroupCommand.cs
// Replaces the generated children and stored parameters for an existing Area Support group as one undoable edit.
...
/// <summary>
/// Updates one Area Support generated group by replacing its generated supports and parametric settings.
/// </summary>
public sealed class UpdateAreaSupportGroupCommand : ICadCommand
{
    private readonly CadDocument _document;
    private readonly SupportLayerGroup _supportLayerGroup;
    private readonly AreaSupportSettings _oldSettings;
    private readonly AreaSupportSettings _newSettings;
    ...
    /// <summary>
    /// Creates an undoable Area Support group update.
    /// </summary>
    public UpdateAreaSupportGroupCommand(
        CadDocument document,
        SupportLayerGroup supportLayerGroup,
        AreaSupportSettings oldSettings,
        IReadOnlyList<SupportEntity> oldSupportEntities,
        AreaSupportSettings newSettings,
    ...
    {
        get { return "Update Area Supports"; }
    }
        ...
        int sourceGeneratorRevision)
    {
        ...
        _supportLayerGroup.SetAreaSupportSettings(settings);
